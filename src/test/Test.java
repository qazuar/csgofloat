...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        List<MarketItemObj> marketItems = r.getMarketItems(MarketEnum.AWP_THE_PRINCE.getMarketLink(ExteriorEnum.FACTORY_NEW.getUrl()), 30);
        ...
        for (MarketItemObj mItem : marketItems) {
            ItemObj item = r.getItem(mItem.getInspectLink());
